...
The gating is pinned by tests: `tests/plugins/msteamsPlugin.test.ts:820` (non-operator is refused
...
**In the repo**, from `/var/www/elowen`:
...
The E2E scenario (`scripts/tests/msteams-e2e/msteams-roundtrip.mjs`) drives a signed activity into the
