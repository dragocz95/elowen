...
const { MissionFlow } = await import('./MissionFlow');
import { createWrapper } from '../../../../web/tests/test-utils';
import type { Task } from '../types';

// Only the hooks this view reads are stubbed; the rest of the module stays real, because the host
// runtime is built from ALL of it (a bare object would leave the bundle without half its contract).
...
vi.mock('../../../../web/lib/elowenClient', async (orig) => ({
  ...(await orig() as object),
