    ...
    <section className="flex items-start gap-3 rounded-lg border border-warning/50 bg-warning/[0.06] p-4">
      ...
      <div className="flex flex-1 flex-col gap-2">
        ...
        <Link
          ...
          className="inline-flex h-9 w-fit items-center justify-center gap-2 rounded-md border border-primary bg-primary px-3.5 text-sm font-medium text-background transition-opacity hover:opacity-90"
        >
