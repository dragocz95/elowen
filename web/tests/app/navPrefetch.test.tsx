...
describe('identity server prefetch', () => {
  ...
  it('renders the admin destinations on the FIRST paint, before any client fetch could have resolved', async () => {
    ...
    // Every destination in the column is a link. What is asserted here is that it is THERE on the
    // first paint, before any client fetch could have decided whether this reader is an admin.
