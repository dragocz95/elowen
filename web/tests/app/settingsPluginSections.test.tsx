...
const server = setupServer(
  http.get('*/api/config', () => HttpResponse.json({ allowedExecs: ['sonnet'], customModels: [], providers: { 'claude-code': { bin: 'claude', args: '' } }, defaults: { exec: 'sonnet', maxSessions: 1 }, security: { tokenTtlDays: 30 } })),
