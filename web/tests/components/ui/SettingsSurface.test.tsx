...
describe('SettingsGroup — collapsible', () => {
  ...
  /** The trigger is a real button: the browser answers Enter and Space with the fold, so the component
   *  owns those keys explicitly (and prevents the default action, so no second toggle can ride behind). */
