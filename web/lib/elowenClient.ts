...
export const elowenClient = {
  ...
  /** Hourly volume for the dashboard heatmap. */
  activityHeatmap: (days: number) => req<HeatmapBucket[]>(`/activity/heatmap?days=${days}`),
