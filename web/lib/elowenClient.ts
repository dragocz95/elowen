...
export const elowenClient = {
  ...
  brainHostedToolSearchStatus: () => req<{ providers: { providerId: string; models: { modelId: string; status: 'supported' | 'unsupported' | 'unverified'; checkedAt: number | null }[] }[] }>('/brain/providers/hosted-tool-search/status'),
