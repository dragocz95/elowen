import { Bot, Boxes, Calendar, Database, FileText, Flag, Folder, Globe, LayoutDashboard, Lightbulb, ListChecks, Puzzle, Rocket, Server, Settings2, ShieldAlert, Sparkles, SquareTerminal, Terminal, Wrench, Zap, type LucideIcon } from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  ...
  ListChecks, Puzzle, Rocket, Server, Settings2, ShieldAlert, Sparkles, SquareTerminal, Terminal, Wrench, Zap,
};
