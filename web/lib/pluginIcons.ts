import { Activity, BarChart3, Blocks, Bot, Box, Boxes, Calendar, Cloud, Contact, Database, FileText, Flag, Folder, GitBranch, GitFork, Github, Globe, KanbanSquare, LayoutDashboard, Lightbulb, ListChecks, MessagesSquare, Puzzle, Rocket, Server, Settings2, ShieldAlert, Sparkles, SquareTerminal, Terminal, Wrench, Zap, type LucideIcon } from 'lucide-react';
 ...
 *  keeping this list in core rather than per-fork. `tests/lib/pluginIcons.test.ts` now fails the build
 *  when a bundled manifest names an icon this map does not have, so the next one is caught here. */
const ICONS: Record<string, LucideIcon> = {
  Activity, BarChart3, Blocks, Bot, Box, Boxes, Calendar, Cloud, Contact, Database, FileText, Flag, Folder, GitBranch,
  GitFork, Github, Globe, KanbanSquare, LayoutDashboard, Lightbulb, ListChecks, MessagesSquare, Puzzle, Rocket, Server,
  Settings2, ShieldAlert, Sparkles, SquareTerminal, Terminal, Wrench, Zap,
};
