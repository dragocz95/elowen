 ...
 *  The former 'providers' (CLI Agents), 'autopilot' and 'github' sections live in the agents plugin's
 *  settings deck now — a stale ?cat= deep-link to them falls back to 'system' via the isSectionId
 *  validator. */
