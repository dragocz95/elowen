...
describe('managed execution boundary', () => {
  ...
  it('rejects an incomplete provider instead of treating it as a managed runtime', () => {
    expect(() => effectiveTurnWorkDir({ ...base, sandbox: {} as SandboxControl })).toThrow(/environment provider/);
  });
