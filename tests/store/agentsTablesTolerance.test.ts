 ...
 *  (missions/mission_pr/agents/notes). OFF = plain openDb, whose schema no longer carries those
 *  tables; ON = openAgentsDb (the plugin's migrations applied). Every path must work in BOTH shapes:
