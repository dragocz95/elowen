...
| `../../screenshots/cli/16-gpt-limits.png` | Terminal chat with GPT-5.5 and telemetry | 1120px terminal | GPT-5.5 terminal conversation with live context and subscription limits | Captured in a disposable English-only demo session; the prompt, reply, and working directory are non-sensitive. |
