...
- The default working directory is the conversation's Project directory, or the directory it was moved to, then the first allowed root.
...
- GitHub publishing requires a committed `HEAD` on an Elowen-created branch; GitHub does not create or remove worktrees.
