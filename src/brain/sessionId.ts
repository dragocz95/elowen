 ...
 *  silently stops matching or an ownership gate misfires. */
 ...
 *  repeated binds on the same channel never collide. Mirrors owner-chat's `freshUserSessionId`
 ...
 *
 *  An owner conversation is its owner's, and so is a DIRECT 1:1 platform chat:
